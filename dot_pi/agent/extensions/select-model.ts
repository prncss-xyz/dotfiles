...
const CURATED_MODELS: { provider: string; id: string; thinking?: ThinkingLevel }[] = [
  ...
  { provider: "opencode-go", id: "deepseek-v4.1-flash", thinking: "low" },
  { provider: "opencode-go", id: "deepseek-v4.1-flash", thinking: "high" },
  { provider: "opencode-go", id: "deepseek-v4.1-flash", thinking: "medium" },
  ...
  { provider: "opencode-go", id: "qwen3.8-flash" },
