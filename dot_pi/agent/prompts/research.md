...
After they return, synthesize what we know and use the `ask_user_question` tool to ask me the unresolved questions needed to reach a shared understanding.
